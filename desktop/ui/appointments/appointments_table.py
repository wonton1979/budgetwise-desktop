...
class AppointmentTable(QFrame):
    ...
    def __init__(self, handle_edit_appointment, handle_delete_appointment):
        super().__init__()
    ...
    def create_appointment_list_table(self, appointments_data):
        ...
        for row, appointment in enumerate(appointments_data):
            ...
            appointment_date = QTableWidgetItem(uk_date_format(appointment["appointment_date"]))
    ...
    def handle_record_cell_clicked(self, row):
        ...
        self.appointment_update_dialog = AppointmentUpdateDialog(self.handle_edit_appointment,
                                                            self.handle_delete_appointment, existing_appointment)
