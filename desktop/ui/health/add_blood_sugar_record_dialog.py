...
from PySide6.QtWidgets import QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QDateEdit, QPushButton, QComboBox, \
    QTextEdit, QTimeEdit, QDialog, QFrame
...
class AddBloodSugarDialog(QDialog):
    def __init__(self,handle_add_health_record,date_format):
        super().__init__()
        self.setWindowTitle("Add Blood Sugar Record")
        self.setModal(True)
        self.resize(600, 390)
    ...
    def initialize_widgets(self):
        ...
        self.add_blood_sugar_record_frame = QFrame()
        self.add_blood_sugar_record_frame.setStyleSheet("""
                                               QFrame {
        ...
        add_blood_sugar_record_frame_layout = QVBoxLayout()
        add_blood_sugar_record_frame_layout.setContentsMargins(10, 10, 10, 10)
        add_blood_sugar_record_frame_layout.setSpacing(4)
        self.add_blood_sugar_record_frame.setLayout(add_blood_sugar_record_frame_layout)
        ...
        add_blood_sugar_record_frame_layout.addLayout(row_one_layout)
        add_blood_sugar_record_frame_layout.addLayout(row_two_layout)
        add_blood_sugar_record_frame_layout.addLayout(notes_layout)
        add_blood_sugar_record_frame_layout.addLayout(error_message_layout)
        add_blood_sugar_record_frame_layout.addLayout(button_row_layout)

        main_layout.addWidget(self.add_blood_sugar_record_frame)
    ...
    def form_validation(self) -> bool:
        ...
        try:
           ...
           if blood_sugar_reading < 3 or blood_sugar_reading > 30:
               self.form_message_label.setText("Please enter a realistic blood sugar reading.")
               return False

        except ValueError:
            self.form_message_label.setText("Please enter a valid blood sugar reading.")
            return False
