    ...
    def initialize_information_dialog(self):
        ...
        for record in day_records:
            ...
            reading_label = QLabel(
                record_time + " : Blood Sugar Level - " + str(record["blood_sugar_reading"]) + "  Reading Type - " + str(
                    record["blood_sugar_reading_type"]))
            ...
            update_button.clicked.connect(
                lambda checked=False, payload=record: self.open_update_blood_sugar_record_dialog(payload)
            )
