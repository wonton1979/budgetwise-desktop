...
from PySide6.QtWidgets import QDialog, QFrame, QVBoxLayout, QHBoxLayout, QComboBox, QLabel, QLineEdit, QDateEdit, \
...
class AddRecurringExpenseDialog(QDialog):
    ...
    def add_recurring_expense(self):
        ...
        row_one_layout.setContentsMargins(0, 0, 0, 8)
        ...
        self.add_recurring_expense_notify_label = QLabel()
        self.add_recurring_expense_notify_label.setWordWrap(True)
        self.add_recurring_expense_notify_label.setStyleSheet("color: #22c55e;font-size: 14px;")
        ...
        self.submit_button = QPushButton("Add Recurring Bill")
        ...
        self.submit_button.clicked.connect(self.handle_add_recurring_expense_button_clicked)

        button_row_layout.addWidget(self.clear_button,1)
        button_row_layout.addWidget(self.submit_button,1)
        ...
        add_recurring_layout.addWidget(self.add_recurring_expense_notify_label)
        add_recurring_layout.addLayout(button_row_layout)

        main_layout.addWidget(self.add_recurring)
    ...
    def handle_add_recurring_expense_button_clicked(self):
        ...
        self.handle_add_recurring_expense(new_recurring_expense_data)
